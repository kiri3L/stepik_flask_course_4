...
days_of_the_week = {"mon": "Понедельник", "tue": "Вторник", "wed": "Среда", "thu": "Четверг", "fri": "Пятница", "sat": "Суббота", "sun": "Воскресенье"}

time_per_week = {"time1": "1-2", "time2": "3-5", "time3": "5-7", "time4": "7-10"}
